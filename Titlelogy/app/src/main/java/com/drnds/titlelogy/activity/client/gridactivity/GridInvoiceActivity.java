...
public class GridInvoiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputordercost = (EditText) findViewById(R.id.input_gridordercost);
        inputsearchcost = (EditText) findViewById(R.id.input_gridsearchcost);
        inputcopycost = (EditText) findViewById(R.id.input_gridcopycost);
        inputnoofpages = (EditText) findViewById(R.id.input_gridnoofpages);
        inputinvoicedate = (EditText) findViewById(R.id.input_gridinvoicedate);
        ...
        CustomRequest customRequest = new CustomRequest(Request.Method.POST, Config.INVOICE_EDIT_URL,null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (!error)
                    {
                        Toasty.success(GridInvoiceActivity.this.getApplicationContext(),"Updated  Sucessfully...", Toast.LENGTH_SHORT).show();
                        hideDialog();

                        onBackPressed();
                    }else {
                        Toasty.success(GridInvoiceActivity.this.getApplicationContext(),"Not updated...",Toast.LENGTH_SHORT).show();
                        hideDialog();
        ...
        if ( connec.getNetworkInfo(0).getState() ==
            ...
            return true;
                ...
                connec.getNetworkInfo(0).getState() ==
                        ...
                        connec.getNetworkInfo(1).getState() ==
                                android.net.NetworkInfo.State.DISCONNECTED  ) {
            TastyToast.makeText( GridInvoiceActivity.this,"Check Internet Connection",TastyToast.LENGTH_SHORT,TastyToast.INFO);
            return false;
        }
        return false;
    }
