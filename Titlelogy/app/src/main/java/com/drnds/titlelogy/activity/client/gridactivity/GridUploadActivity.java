...
public class GridUploadActivity extends AppCompatActivity implements View.OnClickListener ,AlertDialogHelper.AlertDialogListener{
    ...
    String Client_User_Id, Order_Id, clientId, subId, docId, documents, orderNum, Descript,orderdocid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gridupload);
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recycle_gridorderupload);
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        spinner = (Spinner) findViewById(R.id.document_gridorderspinner);
...
//        }
        ...
        attach = (ImageView) findViewById(R.id.upload_gridattach);
...
//                    Toast.makeText(getApplicationContext(), "Details Page", Toast.LENGTH_SHORT).show();
    ...
    private void getDocument() {
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET, Config.DOCUMENT_URL, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                spinner.setAdapter(new ArrayAdapter<String>(GridUploadActivity.this, android.R.layout.simple_spinner_dropdown_item, document));
    ...
    public void UploadDocument() {
        ...
        new MaterialFilePicker()
                .withActivity(GridUploadActivity.this)
...
//            Descript = inputDescript.getText().toString().trim();
            progress = new ProgressDialog(GridUploadActivity.this);
                ...
                public void run() {
                    ...
                    try {
                        ...
                        if (response.isSuccessful()) {
                            ...
                            Intent intent = new Intent(GridUploadActivity.this, EditGridViewActivity.class);
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        mAdapter = new RecyclerUploadAdapter(uploadArrayList,multiselect_list,GridUploadActivity.this);
        ...
        CustomRequest customRequest = new CustomRequest(Request.Method.POST, Config.DELETE_DOCUMENT_URL+orderdocid,null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (!error){
                        Toasty.success( GridUploadActivity.this,"Deleted Successfully...", Toast.LENGTH_SHORT, true).show();
                        onrefresh();
                        hideDialog();
                    }else{
                        Toasty.error( GridUploadActivity.this,"Not Deleted ...", Toast.LENGTH_SHORT, true).show();
                        hideDialog();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
