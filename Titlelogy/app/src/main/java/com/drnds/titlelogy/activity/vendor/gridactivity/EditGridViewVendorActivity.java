...
import com.drnds.titlelogy.activity.vendor.orderqueueactivity.VendorInvoiceActivity;
...
public class EditGridViewVendorActivity extends AppCompatActivity {
    ...
    private TextInputLayout inputLayoutborrowername,inputLayoutordernum,inputLayoutapn,inputlayoutcustomer;
    String County_Name;
    ...
    private String Order_Id,clientname,stringstate,stringcounty,stringorderpriority,stringproducttype,stringstatus,stringcountytype,
            stringordertask,stringorderno,stateid,subclientid;
    private static String TAG = EditGridViewVendorActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clintlogin= getApplicationContext().getSharedPreferences(
                "LoginActivity", 0);
        customerlayout=(LinearLayout)findViewById(R.id.veneditcustomer);
        inputlayoutcustomer=(TextInputLayout)findViewById(R.id.input_layout_customernamespinner);
        inputLayoutborrowername = (TextInputLayout) findViewById(R.id.vendor_input_layout_gridborrowername);
        inputLayoutapn = (TextInputLayout) findViewById(R.id.vendor_input_layout_gridapn);
        inputLayoutordernum = (TextInputLayout) findViewById(R.id.vendor_input_layout_gridordernumber);
        inputcustomer = (EditText) findViewById(R.id.gridvendorinput_editcustomername);
        inputOrdernum = (EditText) findViewById(R.id.vendor_input_gridordernumber);
        inputCity = (EditText) findViewById(R.id.vendor_input_gridcity);
        inputZip = (EditText) findViewById(R.id.vendor_input_gridzip);
        inputAddress = (EditText) findViewById(R.id.vendor_input_gridaddress);
        inputBorrowername = (EditText) findViewById(R.id.vendor_input_gridborrowername);
        inputApn = (EditText) findViewById(R.id.vendor_input_gridapn);
        inputDate = (EditText) findViewById(R.id.vendor_input_griddate);
        spinner1 = (Spinner) findViewById(R.id.vendor_customer_gridspinner);
        spinner2 = (Spinner) findViewById(R.id.vendor_product_gridspinner);
        spinner3 = (Spinner) findViewById(R.id.vendor_state_gridspinner);
        spinner4 = (Spinner) findViewById(R.id.vendor_county_gridspinner);
        spinner5 = (Spinner) findViewById(R.id.vendor_ordertask_gridspinner);
        spinner6 = (Spinner) findViewById(R.id.vendor_status_gridspinner);
        spinner7 = (Spinner) findViewById(R.id.vendor_orderpriority_gridspinner);
        spinner8 = (Spinner) findViewById(R.id.vendor_countytype_gridspinner);
        ...
        subclientid=pref.getString("Sub_Client_Id","");
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(EditGridViewVendorActivity.this, VendorGridUploadActivity.class);
                startActivity(intent);
            }
        });

        invoice=(Button)findViewById(R.id.button_vendorgrideditorderinvoice);
        ...
        submit=(Button)findViewById(R.id.vendor_button_gridsubmit);
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toasty.error(EditGridViewVendorActivity.this, "Please enter all credentials!", Toast.LENGTH_SHORT,true).show();
                    return;
                }
    ...
    private void getCustomer(){
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET, Config.SUBCLIENTORDER_URL+clientID, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                spinner1.setAdapter(new ArrayAdapter<String>(EditGridViewVendorActivity.this, android.R.layout.simple_spinner_dropdown_item, customer));
...
//                        num1=details.getString("State_ID");
                ...
                spinner3.setAdapter(new ArrayAdapter<String>(EditGridViewVendorActivity.this, android.R.layout.simple_spinner_dropdown_item, states));
...
//                        num2=jsonObject.getString("County_ID");
                ...
                spinner4.setAdapter(new ArrayAdapter<String>(EditGridViewVendorActivity.this.getBaseContext(), android.R.layout.simple_spinner_dropdown_item, county));
    ...
    private void getProduct() {
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET, Config.PRODUCTTYPE_URL, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                spinner2.setAdapter(new ArrayAdapter<String>(EditGridViewVendorActivity.this, android.R.layout.simple_spinner_dropdown_item, product));
    ...
    private void getOrdertask() {
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET, Config.ORDERTASK_URL, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                spinner5.setAdapter(new ArrayAdapter<String>(EditGridViewVendorActivity.this, android.R.layout.simple_spinner_dropdown_item, ordertask));
    ...
    private void getStatus(){
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET, Config.ORDERSTATUS_URL, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                spinner6.setAdapter(new ArrayAdapter<String>(EditGridViewVendorActivity.this, android.R.layout.simple_spinner_dropdown_item, status));
    ...
    private void getOrderPriority(){
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET, Config. ORDERPRIORITY_URL, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                spinner7.setAdapter(new ArrayAdapter<String>(EditGridViewVendorActivity.this, android.R.layout.simple_spinner_dropdown_item, orderpriority));
    ...
    private void getcountyType(){
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET, Config.COUNTYTYPE_URL, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                spinner8.setAdapter(new ArrayAdapter<String>(EditGridViewVendorActivity.this, android.R.layout.simple_spinner_dropdown_item, countytype));
...
//                Logger.getInstance().Log("selected county  : " + countyname);
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        inputcustomer.setText(customername);
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (!error)
                    {
                        ...
                        Toasty.success(EditGridViewVendorActivity.this.getApplicationContext(),"Updated  Sucessfully...",Toast.LENGTH_SHORT).show();
                        hideDialog();
    ...
    private boolean checkInternetConnection() {
        ...
        ConnectivityManager connec
                =(ConnectivityManager)EditGridViewVendorActivity.this.getSystemService(EditGridViewVendorActivity.this.CONNECTIVITY_SERVICE);
        ...
        if ( connec.getNetworkInfo(0).getState() ==
            ...
            return true;
                ...
                connec.getNetworkInfo(0).getState() ==
                        ...
                        connec.getNetworkInfo(1).getState() ==
                                android.net.NetworkInfo.State.DISCONNECTED  ) {
            TastyToast.makeText( EditGridViewVendorActivity.this,"Check Internet Connection",TastyToast.LENGTH_SHORT,TastyToast.INFO);
            return false;
        }
        return false;
    }
