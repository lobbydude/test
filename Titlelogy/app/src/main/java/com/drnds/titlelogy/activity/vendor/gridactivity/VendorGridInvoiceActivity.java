...
public class VendorGridInvoiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vendor_grid_invoice);

        inputordercost = (EditText) findViewById(R.id.input_vengridordercost);
        inputsearchcost = (EditText) findViewById(R.id.input_vengridsearchcost);
        inputcopycost = (EditText) findViewById(R.id.input_vengridcopycost);
        inputnoofpages = (EditText) findViewById(R.id.input_vengridnoofpages);
        ...
        if ( connec.getNetworkInfo(0).getState() ==
            ...
            return true;
                ...
                connec.getNetworkInfo(0).getState() ==
                        ...
                        connec.getNetworkInfo(1).getState() ==
                                android.net.NetworkInfo.State.DISCONNECTED  ) {
            TastyToast.makeText( VendorGridInvoiceActivity.this,"Check Internet Connection",TastyToast.LENGTH_SHORT,TastyToast.INFO);
            return false;
        }
        return false;
    }
