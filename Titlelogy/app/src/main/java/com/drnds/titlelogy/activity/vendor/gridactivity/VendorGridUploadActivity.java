...
import com.drnds.titlelogy.activity.client.orderqueueactivity.AlertDialogHelper;
import com.drnds.titlelogy.activity.client.orderqueueactivity.OrderUploadActivity;
import com.drnds.titlelogy.activity.client.orderqueueactivity.RecyclerItemClickListener;
import com.drnds.titlelogy.adapter.vendor.VendorUploadAdapter;
...
public class VendorGridUploadActivity extends AppCompatActivity implements View.OnClickListener ,AlertDialogHelper.AlertDialogListener{
    ...
    private ArrayList<VendorUpload> uploadArrayList = new ArrayList<>();
    ArrayList<VendorUpload> multiselect_list = new ArrayList<>();

    AlertDialogHelper alertDialogHelper;
    private RecyclerView recyclerView;
    private VendorUploadAdapter mAdapter;
    String Vendor_User_Id,Order_Id,Vendor_Id,subId,docId,documents,orderNum,Descript,clientId,orderdocid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.vendor_recycle_gridorderupload);
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        spinner = (Spinner) findViewById(R.id.vendor_document_gridorderspinner);
...
//        }
        ...
        attach = (ImageView) findViewById(R.id.vendor_upload_gridattach);
...
//                    Toast.makeText(getApplicationContext(), "Details Page", Toast.LENGTH_SHORT).show();
            ...
            public boolean onItemLongClick(View view, int position) {
                ...
                if (!isMultiSelect) {
                    multiselect_list = new ArrayList<VendorUpload>();
                    isMultiSelect = true;
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        VendorUpload upload = new VendorUpload ();
                        ...
                        mAdapter = new VendorUploadAdapter(uploadArrayList,multiselect_list,VendorGridUploadActivity.this);
        ...
        CustomRequest customRequest = new CustomRequest(Request.Method.POST, Config.DELETE_DOCUMENT_URL+orderdocid,null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (!error){
                        Toasty.success( VendorGridUploadActivity.this,"Deleted Successfully...", Toast.LENGTH_SHORT, true).show();
                        onrefresh();
                        hideDialog();
                    }else{
                        Toasty.error( VendorGridUploadActivity.this,"Not Deleted ...", Toast.LENGTH_SHORT, true).show();
                        hideDialog();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
