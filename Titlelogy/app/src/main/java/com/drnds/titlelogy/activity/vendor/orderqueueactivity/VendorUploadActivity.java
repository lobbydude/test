...
public class VendorUploadActivity extends AppCompatActivity implements View.OnClickListener ,AlertDialogHelper.AlertDialogListener{
...
//    TextInputLayout descriptionlayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.vendor_recycle_orderupload);
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        spinner = (Spinner) findViewById(R.id.vendor_document_orderspinner);
...
//        }
        ...
        attach = (ImageView) findViewById(R.id.vendor_upload_attach);
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        mAdapter = new VendorUploadAdapter(uploadArrayList,multiselect_list,VendorUploadActivity.this);
        ...
        CustomRequest customRequest = new CustomRequest(Request.Method.POST, Config.DELETE_DOCUMENT_URL+orderdocid,null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (!error){
                        Toasty.success( VendorUploadActivity.this,"Deleted Successfully...", Toast.LENGTH_SHORT, true).show();
                        onrefresh();
                        hideDialog();
                    }else{
                        Toasty.error( VendorUploadActivity.this,"Not Deleted ...", Toast.LENGTH_SHORT, true).show();
                        hideDialog();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
