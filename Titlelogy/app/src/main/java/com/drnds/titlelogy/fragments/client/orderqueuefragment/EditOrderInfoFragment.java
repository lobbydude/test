...
//                        num2=jsonObject.getString("County_ID");
                ...
                spinner4.setAdapter(new ArrayAdapter<String>(getActivity(), android.R.layout.simple_spinner_dropdown_item, county));
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (!error&&!duplicate)
                    {
                        ...
                        Toasty.success( getActivity().getApplicationContext(),"duplicate order",Toast.LENGTH_SHORT).show();
                        hideDialog();
                    }else{
